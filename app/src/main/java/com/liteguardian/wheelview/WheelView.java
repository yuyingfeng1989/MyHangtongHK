...
package com.liteguardian.wheelview;
...
public class WheelView extends View {
    ...
    private static final int VALUE_TEXT_COLOR = 0xF0000000;// ѡ�е�item��ɫ

    /**
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = 0x80666666;
...
//	private static final int[] SHADOWS_COLORS = new int[] { 0x50ff0000,
//		0xa0ff0000, 0xf0ff0000 };
     ...
     * Text size
     */
    public int TEXT_SIZE = 60;
    public int TEXT_SIZE_CUR = 60;
    ...
    private void initData(Context context) {
        float size = context.getResources().getDimension(R.dimen.text_size_wheel);
        float size_cur = context.getResources().getDimension(R.dimen.text_size_wheel);
        TEXT_SIZE = (int) size;
        TEXT_SIZE_CUR = (int) size_cur;
    ...
    public void clearChangingListenr() {
...
//					| Paint.FAKE_BOLD_TEXT_FLAG);
        ...
        if (valuePaint == null) {
            ...
            valuePaint.setTextSize(TEXT_SIZE_CUR);
